...
class Badges{
  ...
  static Widget liveClass(){
    return Container(
      ...
      decoration: BoxDecoration(
        color: purplePrimary().withOpacity(.3),
        borderRadius: borderRadius(radius: 100),
      ),

      child: Text(
        appText.liveClass,
        style: style10Regular().copyWith(color: purplePrimary(), height: .8),
      ),
    );
  }
  ...
  static Widget failed(){
    return Container(
      ...
      decoration: BoxDecoration(
        color: red49.withOpacity(.2),
        borderRadius: borderRadius(radius: 100),
      ),

      child: Text(
        appText.failed,
        style: style10Regular().copyWith(color: red49, height: 1),
      ),
    );
  }
  ...
  static Widget passed(){
    return Container(
      ...
      decoration: BoxDecoration(
        color: green4B.withOpacity(0.2),
        borderRadius: borderRadius(radius: 100),
      ),

      child: Text(
        appText.passed, 
        style: style10Regular().copyWith(color: green4B, height: 1),
      ),
    );
  }
  ...
  static Widget pending(){
    return Container(
      ...
      decoration: BoxDecoration(
        color: yellow29.withOpacity(0.2),
        borderRadius: borderRadius(radius: 100),
      ),

      child: Text(
        appText.pending,
        style: style10Regular().copyWith(color: yellow29, height: 1),
      ),
    );
  }
  ...
  static Widget replied(){
    return Container(
      ...
      child: Text(
        appText.replied,
        style: style10Regular().copyWith(color: purplePrimary(), height: 1),
      ),
    );
  }

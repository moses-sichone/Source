              ...
              child: Column(
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      margin: padding(horizontal: 4, vertical: 4),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            space(0, width: 4),
                            Text(
                              double.parse(courseData.rate ?? '0').toString(),
                              style:
                                  style12Bold().copyWith(color: Colors.white),
                            ),
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            ClipRRect(
                              ...
                              child: fadeInImage(
                                  courseData.teacher?.avatar ?? '', 30, 30),
                            ),
                            space(0, width: 4),
                            Text(
...
Widget courseItem2(CourseModel courseData, {int horizontalPadding = 8}) {
  return GestureDetector(
    onTap: () {
      nextRoute(SingleCoursePage.pageName,
          arguments: [courseData.id, courseData.type == 'bundle']);
      ...
      child: ClipRRect(
        ...
        child: Container(
          ...
          child: Stack(
            children: [
              // image
              fadeInImage(courseData.image ?? '', getSize().width, 130),
                ...
                child: Column(
                  children: [
                    ...
                    Align(
                      alignment: AlignmentDirectional.topEnd,
                      child: Container(
                        margin: padding(horizontal: 2, vertical: 2),
                        padding: padding(horizontal: 12, vertical: 6),
                        decoration: BoxDecoration(
                            color: Colors.white,
                            borderRadius: borderRadius(radius: 35),
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: Text(
                              ...
                              style:
                                  style16Bold().copyWith(color: Colors.black),
                            ),
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                double.parse(courseData.rate ?? '0').toString(),
                                style:
                                    style12Bold().copyWith(color: Colors.black),
                              ),
                            ],
                          ),
  ...
  return Theme(
    ...
    child: TextFormField(
      ...
      decoration: InputDecoration(
        hintText: hint,
        hintStyle: style14Regular().copyWith(
            letterSpacing: 0, fontSize: 14, color: greyText(), height: 1.3),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: style12Regular().copyWith(color: headerTextColor()),
                ),
              ],
            ),
          )
      ...
      GestureDetector(
        ...
        child: Container(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: state ? purplePrimary() : greyE7,
    ...
    children: [
      ...
      SizedBox(
        ...
        child: Transform.scale(
          scale: 0.6, // Adjust scale factor as needed
    ...
    child: Row(
      ...
      children: [
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
              shape: BoxShape.circle,
              color: state ? purplePrimary() : lightGrey(),
              boxShadow: [boxShadow(greyD0.withOpacity(.38), blur: 10, y: 3)]),
          child: state? const Icon(Icons.check, color: Colors.white, size: 16) : const SizedBox.shrink(),
        ),
        space(0, width: 12),
        Text(
          title,
    ...
    child: Row(
      ...
      children: [
        ...
        AnimatedContainer(
          ...
          alignment: Alignment.center,
          child: state?SvgPicture.asset(AppAssets.checkSvg): const SizedBox.shrink(),
        ),
      ],
    ),
  );
    ...
    title: Directionality(
      ...
      child: Padding(
        padding: EdgeInsets.only(
            bottom: 8, top: 8, left: leftMargin ?? 0, right: rightMargin ?? 0),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            if (leftIcon == null) ...{
            ...
            Expanded(
              child: Padding(
                ...
                child: Center(
                  child: Text(
                    title,
                    style: style16Bold().copyWith(color: grey3A),
                  ),
                ),
              ),
            ),
                ...
                builder: (context, provider, child) {
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.white,
                        borderRadius: borderRadius(radius: 24),
                      ),
                      child: Stack(
                        children: [
                          Align(
          ...
          firstChild: Row(
            ...
            children: [
              if (iconPath != null) ...{
                ...
                iconPath.contains('png')?Image.asset(iconPath, width: icWidth?.toDouble(), color: iconColor):
                SvgPicture.asset(
                  iconPath,
                  colorFilter: iconColor != null
                      ? ColorFilter.mode(iconColor, BlendMode.srcIn)
              ...
              if (text.isNotEmpty) ...{
                Expanded(child: Text(
                  ...
                  style: style14Regular().copyWith(fontSize: fontSize.toDouble(), color: textColor),
                ),),
              }
            ],
          ),
...
Widget emptyState(String icon, String title, String desc,
  ...
  return Column(
    mainAxisAlignment: MainAxisAlignment.center,
    children: [
      icon.isEmpty?const SizedBox.shrink():icon.contains('.svg')?SvgPicture.asset(icon):Image.asset(icon, width: 100),
      icon.isEmpty?const SizedBox.shrink():space(20),
      Text(
        title,
        style: style20Bold(),
      ),
  ...
  return GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius:
            borderRadius(radius: 25), // Apply rounded corners only to bottom
        ...
        children: [
          Column(
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: fadeInImage(user.avatar ?? '', double.infinity, 90,
                    fit: BoxFit.fitWidth), // Full width
              ),
          ...
          Positioned(
              ...
              child: Container(
                  ...
                  child: Image.asset(
                    'assets/image/png/CalendarDots.png',
                    width: 22,
                  )))
        ],
      ),
...
Widget userCard(String image, String title, String desc, String date,
  ...
  return GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
          color: Colors.white, borderRadius: borderRadius(radius: 20)),
      child: Row(
        children: [
          ClipRRect(
            borderRadius: borderRadius(radius: 10),
                  ...
                  children: [
                      ...
                      Row(
                        children: [
                          SvgPicture.asset(
                            AppAssets.timeSvg,
                            colorFilter:
                                ColorFilter.mode(greyText(), BlendMode.srcIn),
                          ),
                          space(0, width: 4),
                          Text(
                            '${time.start}-${time.end}',
                    ...
                    if (price.isNotEmpty) ...{
                      ...
                      Text(
                        price,
                        style:
                            style16Regular().copyWith(color: purplePrimary()),
                      )
                    },
...
Widget tabBar(
  ...
  return Align(
    ...
    child: TabBar(
        ...
        padding: padding(horizontal: horizontalPadding, vertical: 20),
        indicator: const BoxDecoration(),
        labelStyle: style14Regular().copyWith(fontWeight: FontWeight.w600),
        unselectedLabelStyle:
            style14Regular().copyWith(fontWeight: FontWeight.w600),
        labelColor: purplePrimary(),
        dividerColor: Colors.transparent,
        labelPadding: padding(horizontal: 0, vertical: 0),
        ...
        tabs: tab
            .map((item) => Container(
                  ...
                  decoration: BoxDecoration(
                          color:  tabController.index == tab.indexOf(item)
                              ? iconBg() : Colors.white,
                          borderRadius: borderRadius(radius: 30)),
                  child: item,
                ))
...
Widget blogItem(BlogModel blog, Function onTap) {
  return GestureDetector(
    ...
    child: Container(
      ...
      margin: const EdgeInsets.only(bottom: 16),
      decoration: BoxDecoration(
        color: purplePrimary().withOpacity(.08),
        borderRadius: borderRadius(radius: 22),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Hero(
            ...
            child: ClipRRect(
              ...
              child: Stack(
                children: [
                  fadeInImage(blog.image ?? '', getSize().width, 120),
                  Container(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                HtmlWidget(
                  blog.description ?? '',
                  textStyle: style12Regular().copyWith(color: greyText(), overflow: TextOverflow.ellipsis),
                ),
                ...
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        SvgPicture.asset(AppAssets.commentSvg, width: 12,),
                        space(0, width: 2),
                        Text(
                          '${blog.commentCount}',
                          style: style10Regular().copyWith(color: headerTextColor(), fontWeight: FontWeight.bold),
                        )
                      ],
                    ),
                    space(0, width: 15),
                    Row(
                      children: [
                        // SvgPicture.asset(AppAssets.calendarSvg, width: 15,),
                        // space(0, width: 5),
                        Text(
  ...
  return Container(
    ...
    child: Row(
      children: [
        ClipRRect(
            borderRadius: borderRadius(radius: 35),
            child: fadeInImage(user.avatar ?? '', 50, 50)),
        space(0, width: 6),
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            if (showRate) ...{
              ...
              Row(
                children: [
                  ...
                  space(0, width: 4),
                  Text(
                    double.parse(customRate ?? user.rate.toString()).toString(),
                    style: style12Regular().copyWith(
                        color: Colors.black,
                        fontWeight: FontWeight.w600,
                        letterSpacing: 1.2),
...
RatingBar ratingBar(String rate,
    {int itemSize = 18, Function(double)? onRatingUpdate}) {
  return RatingBar(
          ...
          child: Row(
            children: [
              Container(
                ...
                height: 60,
                decoration: BoxDecoration(
                    color: iconBg(), borderRadius: borderRadius(radius: 12)),
                alignment: Alignment.center,
                child: Image.asset(
                  'assets/image/png/question-mark.png',
                  width: 25,
                ),
              ),
              space(0, width: 8),
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          comment.comment ?? '',
          style: style14Regular().copyWith(color: greyText(), height: 1.5),
        ),
        ...
        Text(
          ...
          style: style14Regular().copyWith(
              color: Colors.black, fontWeight: FontWeight.w600, height: 1.5),
        ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: style14Regular()
                        .copyWith(color: greyText(), height: 1.5),
                  ),
...
Widget dashboardInfoBox(
  ...
  return GestureDetector(
    ...
    behavior: HitTestBehavior.opaque,
    child: Container(
      width: getSize().width / 2.2,
      height: getSize().width / 2.5,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                subTitle,
                style: style16Regular().copyWith(color: headerTextColor()),
              ),
              icon.contains('.png')?Image.asset(icon, width: icWidth.toDouble()):
              SvgPicture.asset(icon,
          ...
          Text(
            title,
            style: style24Bold().copyWith(color: headerTextColor(), fontSize: 35),
          ),
        ],
      ),
    ),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style:
                                  style10Regular().copyWith(color: greyText()),
                            ),
                          ],
                        ),
...
Widget helperBox(String icon, String title, String subTitle,
    {int iconSize = 30, int horizontalPadding = 21}) {
  return Container(
    width: getSize().width,
    padding: padding(vertical: 5, horizontal: 5),
        ...
        Expanded(
          ...
          children: [
            ...
            Text(
              subTitle,
              style: style12Regular()
                  .copyWith(color: greyText(), fontWeight: FontWeight.w400),
            ),
          ],
        )),
      ],
...
Widget helperBox2(String icon, String title, String subTitle,
    {int iconSize = 30, int horizontalPadding = 21, Function? onTapBox, Color? iconBgColor}) {
  return GestureDetector(
    onTap: (){
      onTapBox!();
    },
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                color: iconBgColor??iconBg(), borderRadius: BorderRadius.circular(12)),
            alignment: Alignment.center,
            child: icon.contains('.png')?Image.asset(
              icon,
              width: iconSize.toDouble(),
            ):SvgPicture.asset( icon,
              width: iconSize.toDouble(),
      ...
      child: Column(
        ...
        children: [
          ...
          LinearProgressIndicator(
            backgroundColor: purplePrimary().withOpacity(.2),
            value: progress,

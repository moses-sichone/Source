...
class TextbookMainDrawer extends StatefulWidget {
  const TextbookMainDrawer({super.key});

  @override
  State<TextbookMainDrawer> createState() => _TextbookMainDrawerState();
}

class _TextbookMainDrawerState extends State<TextbookMainDrawer> {
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  ? Container(
                                      ...
                                      child: Image.asset(
                                        'assets/image/png/logo_clear.png',
                                        width: 75,
                                        height: 75,
                                    ),
                                  )
                                  : Image.network(
                                      ...
                                      errorBuilder: (context, error, stackTrace) {
                                        return Image.asset('assets/image/png/logo_clear.png', width: 75, height: 75, fit: BoxFit.cover);
                                      },
                                      fit: BoxFit.cover,
                                    ),
                                  ),

...
class SingleCourseWidget{
            ...
            child: Row(
              children: [
                ...
                if(courseData.type == 'bundle')...{
                  courseOption(purplePrimary().withOpacity(.5), AppAssets.playCircleSvg, bundleCourses.length.toString(), appText.courses),
                },
                ...
                if(courseData.support ?? false)...{
                  courseOption(supportedColor(), AppAssets.supportedSvg, appText.supported, appText.class_),
                },
                
                if(courseData.isDownloadable ?? false)...{
                  courseOption(downloadableColor(), AppAssets.downloadableSvg, appText.downloadable, appText.content),
                },
              ],
            ),
          ),
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(appText.viewMore, style: style14Regular().copyWith(fontSize: 16, color: Colors.black, fontWeight: FontWeight.w600),),
                          space(0, width: 10),
                          SvgPicture.asset('assets/image/svg/ArrowRight.svg', color: Colors.black,),
                        ],
                      ),
                    ),
                  ),
  ...
  static Widget contentPage(SingleCourseModel courseData,List<ContentModel> contents,{List<CourseModel> bundleCourses = const []}){
    ...
    String iconType(ContentItem item) {
      ...
      switch (item.type) {
        ...
        case 'file':
          return item.downloadable == 1 ? AppAssets.paperDownloadSvg : 'assets/image/png/video-icon.png';
    ...
    int sizeType(ContentItem item){
      ...
      switch (item.type) {
        ...
        case 'file':
          return item.downloadable == 1 ? 24 : 32;
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: style14Regular().copyWith(color: Colors.black, height: 1.5, fontWeight: FontWeight.w600),
          ),
          space(8),
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          Text(
              desc,
              style: style14Bold().copyWith(fontSize: 28, color: headerTextColor())
          ),
          Text(
            title,
            style: style12Regular().copyWith(color: greyText(), fontSize: 14),
          ),
        ],
      ),
    );
  ...
  static Widget courseStatus2(String title,String desc,String iconPath, {double? width}){
    return SizedBox(
      width: width ?? (getSize().width / 2) - 40,
      child: Row(
        children: [
          iconPath.contains('svg')?SvgPicture.asset(iconPath):Image.asset(iconPath, width: 30,),
          space(0, width: 8),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Text(
                  desc,
                  style: style14Bold().copyWith(fontSize: 16, color: headerTextColor())
              ),
            ],
          ),
        ],
                      ...
                      child: GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: borderRadius(),
                            border: Border.all(
                              color: (selectedTicket?.id ?? -1) == courseData.tickets[index].id ? purplePrimary() : greyE7,
                              width: 1
                            )
                          ),
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                ...
                                height: 45,
                                decoration: BoxDecoration(
                                  color: (courseData.tickets[index].isValid ?? false) ? purplePrimary() : greyCF,

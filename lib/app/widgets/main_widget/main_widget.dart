      ...
      child: Container(
        ...
        child: Stack(
          children: [
            Align(
              alignment: Alignment.center,
              child: iconPath.contains('svg')?SvgPicture.asset(iconPath,colorFilter: ColorFilter.mode(iconColor, BlendMode.srcIn),):Image.asset(iconPath, color: Colors.black,),
            ),
      ...
      child: GestureDetector(
        ...
        child: Container(
          padding: const EdgeInsets.all(18),
            decoration: thisPage == selectedPage? BoxDecoration(
              shape: BoxShape.circle,
              color: purplePrimary()
            ):null,
            child: SvgPicture.asset(icon, colorFilter: ColorFilter.mode(thisPage == selectedPage?Colors.white:Colors.black, BlendMode.srcIn),)),
      ),
    );

            ...
            child: Row(
              children: [
                AnimatedFlipCounter(
                  ...
                  wholeDigits: 2,
                  suffix: ':',
                  textStyle: style22Bold().copyWith(color: greyText(), fontSize: 40),
                ),
                AnimatedFlipCounter(
                  duration: const Duration(milliseconds: 300),
                  value: (seconds ?? 0),
          ...
          ? Border.all(
              color: userAnswer == null
                ...
                : (userAnswer.answer.toString() != answer.id.toString())
                  ? Colors.white
                  : (userAnswer.status ?? false) ? purplePrimary() : red49,
              width: 2.2
            )
          : Border.all(color: answer.isSelected ? purplePrimary() : Colors.white.withOpacity(0), width: 2.2),
...
class CustomSliderTrackShape extends RoundedRectSliderTrackShape {
  ...
  Rect getPreferredRect({
    ...
    return Rect.fromLTWH(trackLeft + 1, trackTop, trackWidth, trackHeight);
  }
}
...
class _AssignmentsPageState extends State<AssignmentsPage> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return directionality(
      child: Scaffold(
        appBar: appbar(title: appText.assignments, leftMargin: 16),
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [
                  ...
                  ? loading() : myAssignments.isEmpty
                  ? emptyState('assets/image/png/empty-box.png', appText.dataNotFound, appText.dataNotFoundDesc)

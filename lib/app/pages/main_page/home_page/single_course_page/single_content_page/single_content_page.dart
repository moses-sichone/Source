              ...
              children: [
                ...
                Expanded(
                  child: button(
                    ...
                    height: 52, 
                    text: appText.join, 
                    bgColor: (singleContentData?.isFinished ?? false) ? greyCF.withOpacity(.8) : purplePrimary(), 
                    textColor: Colors.white
                  )
                ),
                ...
                Expanded(
                  child: button(
                    ...
                    bgColor: Colors.white,
                    textColor: (singleContentData?.isFinished ?? false) ? greyCF : purplePrimary(),
                    borderColor: (singleContentData?.isFinished ?? false) ? greyCF.withOpacity(.8) : purplePrimary(), 

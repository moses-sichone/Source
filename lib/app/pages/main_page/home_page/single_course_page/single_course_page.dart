                          ...
                          children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        ratingBar(courseData?.rate?.toString() ?? '0', itemSize: 20),

                                        space(0,width: 4),

                                        Text(
                                          double.parse(courseData?.rate?.toString() ?? '0').toString(),
                                          style: style12Regular().copyWith(color: Colors.black, fontWeight: FontWeight.w600, letterSpacing: 1.2),
                                        )
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                userProfile(courseData!.teacher!,showRate: true, isBoldTitle: true),

                                RotatedBox(
                                  quarterTurns: 3,
                                  child: closeButton(AppAssets.menuCircleSvg, width: 18, icColor: greyB2, onTap: (){
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: style12Regular().copyWith(
                                  color: (courseData!.discountPercent ?? 0) > 0 ? greyCF : purplePrimary(),
                                  decoration: (courseData!.discountPercent ?? 0) > 0 ? TextDecoration.lineThrough : TextDecoration.none,
                                  decorationColor: (courseData!.discountPercent ?? 0) > 0 ? greyCF : purplePrimary(),
                                ),
                              ),

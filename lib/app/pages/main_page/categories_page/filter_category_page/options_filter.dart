        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              switchButton2(appText.upcomingClasses, upcomingClasses, (value) {
                setState(() {
              ...
              switchButton2(appText.freeClasses, freeClasses, (value) {
                setState(() {
                  freeClasses = value;
                });
              }),
              ...
              switchButton2(appText.discountedClasses, discountClasses, (value) {
                setState(() {
              ...
              switchButton2(appText.downloadableContent, downloadabeClasses, (value) {
                setState(() {
              ...
              switchButton2(appText.bundleCourse, bundleCourse, (value) {
                setState(() {
                  bundleCourse = value;
                });
              }),
              ...
              Text(
                appText.sortBy,
                style: style20Bold().copyWith(color: headerTextColor()),
              ),

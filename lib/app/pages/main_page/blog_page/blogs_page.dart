        ...
        builder: (context, drawerProvider ,_) {
          ...
          return ClipRRect(
            ...
            child: Scaffold(
              ...
              body: !isLoading && blogData.isEmpty ? Center(
                  ...
                  child: Column(
                    children: [
                      ...List.generate((isLoading && blogData.isEmpty) ? 3 : blogData.length,
                        (index) {
                          return (isLoading && blogData.isEmpty) ? blogItemShimmer() : blogItem(blogData[index], () {
